    ...
    .map(
      ...
      <tr>
        ...
        <td class="admin-inline-actions">
          <button type="button" class="btn btn-sm btn-outline-primary" data-edit-msg="${msg.id}" aria-label="Edit message ${msg.title}" title="Edit">
          ...
          <button type="button" class="btn btn-sm btn-outline-danger" data-delete-msg="${msg.id}" aria-label="Delete message ${msg.title}" title="Delete">
            <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 16 16" fill="currentColor" aria-hidden="true" focusable="false">
